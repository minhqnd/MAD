...
- `src/main.py` – chương trình CLI tạo cây cho các biểu thức trong đề, in kết quả và vẽ cây ASCII.
...
CLI sẽ in từng biểu thức, chuỗi prefix/postfix tương ứng, kết quả tính toán và sơ đồ cây ASCII. Nếu gặp chia cho 0, chương trình vẫn hiển thị duyệt cây và chú thích “undefined (division by zero)” để dễ kiểm tra.
